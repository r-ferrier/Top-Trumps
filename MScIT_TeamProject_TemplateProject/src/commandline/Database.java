...
public class Database {
	...
	private Statement stmt;
	    ...
	    public void connectToDataBase(){
	        ...
	        /*
	        * This will connect our program to the database so our data can be updated and recieved.
	        */
	    ...
	    private void createNewTable() {
	        ...
	        /*
	        * This creates a new table for the persistant game data if one does not already exist
	        * I am currently working under the assumption that we don't want a new table each time 
	        * we call the program to run - but this can easily be changed. 
	        */
	    	try {
	    ...
	    private void pullGameStats(){
	        ...
	        /*
	        * This will print the information about the previous games, while the game is not in progress. 
	        */
	        ...
	        ResultSet avgDraws = stmt.executionQuery("SELECT ADD*(number_of_draws)/COUNT*(number_of_draws) FROM game_stats");
	        while (avgDraws.next()) {
